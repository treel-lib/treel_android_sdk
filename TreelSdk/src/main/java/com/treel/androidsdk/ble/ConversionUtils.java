...
/**
 * Class responsible for conversion of sensors data to readable format
...
public class ConversionUtils {
    ...
    public static final String UNIT_PRESSURE = "PSI";
    ...
    public static TreelBeacon getTreelBeacon(byte[] scanRecord) {
        int startByte = 2;
        ...
        if (patternFound) {
            ...
            if (uuid.equalsIgnoreCase(BluetoothUUID.INSTANCE.getTREEL_IBEACON_SERVICE_UUID().toString())) {
                // major
                ...
                //Timber.d("UUID: " + uuid + "\\nmajor: " + major + "\\nminor" + minor);
                return new TreelBeacon(uuid, minor);
            }
        }
        return null;
