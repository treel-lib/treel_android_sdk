...
public class BleScanException extends RuntimeException {
    ...
    /**
     * Fails to start scan as Sensor Configuration not available on Local Database
     */
    public static final int SCAN_FAILED_CONFIGURATION_NOT_AVAILABLE = 10;
    ...
    public BleScanException(@com.polidea.rxandroidble2.exceptions.BleScanException.Reason int reason) {
        super(createMessage(reason, null));
        this.reason = reason;
        this.retryDateSuggestion = null;
    }

    public BleScanException(@com.polidea.rxandroidble2.exceptions.BleScanException.Reason int reason, @NonNull Date retryDateSuggestion) {
        super(createMessage(reason, retryDateSuggestion));
        this.reason = reason;
        this.retryDateSuggestion = retryDateSuggestion;
    }

    public BleScanException(@com.polidea.rxandroidble2.exceptions.BleScanException.Reason int reason, Throwable causeException) {
     ...
     *
     * @return One of the {@link com.polidea.rxandroidble2.exceptions.BleScanException.Reason} codes.
     */
    @com.polidea.rxandroidble2.exceptions.BleScanException.Reason
    ...
    /**
     * Returns a {@link Date} suggestion when a particular {@link com.polidea.rxandroidble2.exceptions.BleScanException.Reason} should no longer be valid
     *
    ...
    private static String reasonDescription(int reason) {
        switch (reason) {
            ...
            case SCAN_FAILED_CONFIGURATION_NOT_AVAILABLE:
                return "Sensor Configuration not available";
